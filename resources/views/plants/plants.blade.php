                    ...
                    <div class="card">
                        ...
                        <footer class="card-footer">
                            <p class="card-footer-item">
                                <button onclick="location.href='{{ route('getPlantForEdit', $plant->id) }}'"
                                    type="button" class="button mt-5" id="edit">Edit</button>
                                <button onclick="location.href='{{ route('viewPlant', $plant->id) }}'" type="button"
                                    class="button mt-5" id="view">View</button>
                      ...
                      if(confirm('Jeste li sigurni da želite izbrisati ovu biljku?')) {
                            ...
                            <form id="deletePlant_{{ $plant->id }}"
                                action="{{ route('deletePlant', ['plantId' => $plant->id]) }}" method="POST">
                                @csrf
                            </form>
                            </p>
                        </footer>
