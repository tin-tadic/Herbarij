        ...
        <div class="form">
            <form class="contact-form" action="/dodaj-biljku" method="POST" enctype="multipart/form-data">
                ...
                <label class="label" for="sorta">
                    ...
                    <input class="input is-success" id="sorta" type="text" name="sorta" placeholder="Sorta" />
                ...
                <label class="label" for="kategorija">
                    ...
                    <input class="input is-success" id="kategorija" type="text" name="kategorija" placeholder="Kategorija" />
                ...
                <label class="label" for="naziv_dobavljaca">
                    ...
                    <input class="input is-success" id="naziv_dobavljaca" type="text" name="naziv_dobavljaca" placeholder="Naziv dobavljaca" />
